...
```
    ...
    ##  [1] RColorBrewer_1.1-3 bslib_0.9.0        compiler_4.2.3     pillar_1.11.1     
    ##  [5] jquerylib_0.1.4    tools_4.2.3        digest_0.6.39      nlme_3.1-168      
    ##  [9] lattice_0.22-7     jsonlite_2.0.0     evaluate_1.0.5     lifecycle_1.0.4   
    ## [13] tibble_3.3.0       gtable_0.3.6       pkgconfig_2.0.3    rlang_1.1.6       
    ## [17] psych_2.5.6        cli_3.6.5          rstudioapi_0.17.1  parallel_4.2.3    
    ## [21] yaml_2.3.12        pkgdown_2.2.0      xfun_0.55          fastmap_1.2.0     
    ## [25] withr_3.0.2        knitr_1.51         desc_1.4.3         generics_0.1.4    
    ## [29] fs_1.6.6           htmlwidgets_1.6.4  sass_0.4.10        vctrs_0.6.5       
    ## [33] systemfonts_1.3.1  plot3D_1.4.2       grid_4.2.3         tidyselect_1.2.1  
    ## [37] glue_1.8.0         R6_2.6.1           textshaping_1.0.4  tcltk_4.2.3       
    ## [41] otel_0.2.0         rmarkdown_2.30     farver_2.1.2       magrittr_2.0.4    
    ## [45] scales_1.4.0       htmltools_0.5.9    misc3d_0.9-1       mnormt_2.1.1      
    ## [49] labeling_0.4.3     S7_0.2.1           ragg_1.5.0         cachem_1.1.0
